...
jQuery(document).ready(function($){
    ...
    function nectarSliderMainInit() {
    	...
    	$('.nectar-slider-wrap').each(function(i){
          ...
          //底部导航
          $('#banner-btn-01').on('click',function(){
            $nectarSliders[i].swipeTo(0);
          });
          $('#banner-btn-02').on('click',function(){
            $nectarSliders[i].swipeTo(1);
          });
          $('#banner-btn-03').on('click',function(){
            $nectarSliders[i].swipeTo(2);
          });
    	});
